      ...
      <div className="mt-6 border-t-2 border-gray-200 pt-4">
         <div className="flex justify-between items-center mb-3">
            <div className="flex items-center gap-2">
                ...
                <button onClick={onReset} className="flex items-center gap-1 px-2 py-1 bg-amber-50 hover:bg-amber-100 text-amber-600 border border-amber-200 rounded text-[10px] font-bold transition-colors">
